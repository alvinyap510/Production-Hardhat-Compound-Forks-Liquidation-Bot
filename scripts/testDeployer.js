...
/********************/
async function main() {
  console.log("Original Liquidity:");
  console.log(
  ...
  console.log("Deploying MirrorCompoundForksLiquidationBot contract");
  const MirrorCompoundForksLiquidationBotFactory =
    await ethers.getContractFactory("MirrorCompoundForksLiquidationBot");
  const MirrorCompoundForksLiquidationBot =
    await MirrorCompoundForksLiquidationBotFactory.deploy(
  ...
  await MirrorCompoundForksLiquidationBot.deployed();
  console.log(
    "Successfully deployed MirrorCompoundForksLiquidationBot at address: "
  );
  console.log(MirrorCompoundForksLiquidationBot.address);
  console.log("\n");
  //
  await mine(2300000);
